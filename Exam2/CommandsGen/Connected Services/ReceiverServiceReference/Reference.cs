...
namespace CommandsGen.ReceiverServiceReference {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(CommandsGen.ReceiverServiceReference.StopCommand))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(CommandsGen.ReceiverServiceReference.MouseMoveCommand))]
    ...
    [System.SerializableAttribute()]
    public partial class StopCommand : CommandsGen.ReceiverServiceReference.MouseCommand {
    }
    ...
    [System.SerializableAttribute()]
    public partial class MouseMoveCommand : CommandsGen.ReceiverServiceReference.MouseCommand {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ReceiverServiceReference.IReceiver")]
    public interface IReceiver {
        ...
        bool SendCommands(CommandsGen.ReceiverServiceReference.MouseCommand[] command);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IReceiver/SendCommands", ReplyAction="http://tempuri.org/IReceiver/SendCommandsResponse")]
        System.Threading.Tasks.Task<bool> SendCommandsAsync(CommandsGen.ReceiverServiceReference.MouseCommand[] command);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IReceiverChannel : CommandsGen.ReceiverServiceReference.IReceiver, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ReceiverClient : System.ServiceModel.ClientBase<CommandsGen.ReceiverServiceReference.IReceiver>, CommandsGen.ReceiverServiceReference.IReceiver {
        ...
        public bool SendCommands(CommandsGen.ReceiverServiceReference.MouseCommand[] command) {
            return base.Channel.SendCommands(command);
        }
        
        public System.Threading.Tasks.Task<bool> SendCommandsAsync(CommandsGen.ReceiverServiceReference.MouseCommand[] command) {
